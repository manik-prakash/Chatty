...
const ChatRoom = ({ room, user, onBack }) => {
  ...
  // return (
  //   <div className="h-screen bg-linear-to-br from-gray-900 via-purple-900 to-black flex flex-col">
  //     <div className="bg-gray-900 px-6 py-4 shadow-lg flex justify-between items-center border-b border-gray-800">
  //       <h1 className="text-purple-300 text-2xl font-bold">{room.name}</h1>
  //       <button
  //         onClick={() => {
  //           onBack();
  //           navigate('/rooms');
  ...
  //               <span className={`font-semibold text-sm ${msg.user.username === user.username ? 'text-purple-300' : 'text-gray-300'
  //                 }`}>
  //                 {msg.user.username}
  //               </span>
  ...
  //               ? 'bg-purple-700 text-white border-l-4 border-purple-800'
  //               : 'bg-gray-800 text-gray-200 border-l-4 border-purple-600'
  //               }`}>
  //               {msg.content}
  //             </div>
  //           </div>
  ...
  //       <div className="p-5 bg-gray-900 border-t-2 border-gray-800 flex gap-2">
  //         <input
  //           type="text"
  //           value={messageInput}
  ...
  //           className="flex-1 px-4 py-3 bg-gray-800 border-2 border-gray-700 rounded-lg text-sm text-gray-100 focus:outline-none focus:border-purple-500 placeholder-gray-500"
  //           autoComplete="off"
  //         />
  //         <button
  //           onClick={sendMessage}
  //           disabled={!connected}
  //           className="bg-purple-600 text-white px-8 py-3 rounded-lg text-sm font-semibold hover:bg-purple-700 hover:-translate-y-0.5 hover:shadow-lg transition-all disabled:bg-gray-700 disabled:cursor-not-allowed disabled:transform-none"
  //         >
  //           Send
  //         </button>
  //       </div>
